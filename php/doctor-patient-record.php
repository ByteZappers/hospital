        ...
        <div class="row">
            <div class="col-md-12">
	            <div class="portlet-body">
	                <table id="table-pagination" data-toggle="table" data-url="../assets/global/plugins/bootstrap-table/data/data-doctor-search.json" data-height="300" data-pagination="true"
	                data-search="true">
	                    <thead>
	                        <tr>
	                            ...
	                            <th data-field="symptoms" data-align="left">Symptoms</th>
